...
export default function TabLayout() {
  ...
  return (
    <Tabs
      ...
      {/* Pantalla "menuInicio", con barra de navegación */}
      <Tabs.Screen
        name="docs"
        options={{
          title: 'Docs',
          tabBarIcon: ({ color }) => (
            <MaterialCommunityIcons name="file-document" size={28} color="#880216" />
          ),
        }}
      />
      <Tabs.Screen
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Contacto',
          tabBarIcon: ({ color }) => <MaterialCommunityIcons name="phone-message" size={28} color="#880216" />,
        }}
      />
      {/* Pantalla "informacion", con barra de navegación */}
      <Tabs.Screen
        name="informacion"
        options={{
          title: 'Información',
          tabBarIcon: ({ color }) => <MaterialCommunityIcons name="account" size={28} color="#880216" />,
        }}
      />
      <Tabs.Screen
        name="newPassword"
